...
public partial class TutorialOverlay : Control
{
    ...
    private static readonly (string Title, string Body, bool Danger)[] Steps =
    {
        ...
        ("Reserves & bosses", "Pieces beyond the battlefield wait in your reserve — tap their button below, then a lit tile, to deploy (it costs your action). Every 4th battle a boss bends the rules.", false),
    };
